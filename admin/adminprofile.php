...
$res=mysqli_query($con,"UPDATE admin SET adminFirstName='$adminFirstName', adminLastName='$adminLastName', adminPhone='$adminPhone', adminEmail='$adminEmail', "
                 . "adminAddress='$adminAddress' WHERE adminId=".$_SESSION['adminSession']);
