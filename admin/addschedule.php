...
//INSERT
$query = " INSERT INTO carwashschedule ( ScheduleDate, ScheduleDay, StartTime, EndTime, bookavail)
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="admindashboard.php">Welcome Admin - <?php echo $userRow['adminFirstName'];?> <?php echo $userRow['adminLastName'];?></a>
                </div>
                <!-- Top Menu Items -->
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li class="active">
                            <a href="addschedule.php"><i class="fa fa-fw fa-table"></i> Car Wash Schedule</a>
                        </li>
                        <li>
                            <a href="customerlist.php"><i class="fa fa-fw fa-edit"></i> Customer's List</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <!-- panel heading starat -->
                        <div class="panel-heading">
                            <h3 class="panel-title">List of Appointment Slots</h3>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <?php 
                            $result=mysqli_query($con,"SELECT * FROM carwashschedule");
                            

                                  
                            while ($carwashschedule=mysqli_fetch_array($result)) {
                                
                              
                                echo "<tbody>";
                                echo "<tr>";
                                    echo "<td>" . $carwashschedule['ScheduleId'] . "</td>";
                                    echo "<td>" . $carwashschedule['ScheduleDate'] . "</td>";
                                    echo "<td>" . $carwashschedule['ScheduleDay'] . "</td>";
                                    echo "<td>" . $carwashschedule['StartTime'] . "</td>";
                                    echo "<td>" . $carwashschedule['EndTime'] . "</td>";
                                    echo "<td>" . $carwashschedule['bookavail'] . "</td>";
                                    echo "<form method='POST'>";
                                    echo "<td class='text-center'><a href='#' id='".$carwashschedule['ScheduleId']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>
                            </td>";
