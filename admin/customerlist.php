                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-calendar"></i> Customer List
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-primary filterable">
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    <th><input type="text" class="form-control" placeholder="IC" disabled></th>
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Car Model" disabled></th>
                            ...
                            while ($custRow=mysqli_fetch_array($result)) {
                                
                              
                                echo "<tbody>";
                                echo "<tr>";
                                    echo "<td>" . $custRow['ic'] . "</td>";
                                    echo "<td>" . $custRow['LastName'] . "</td>";
                                    echo "<td>" . $custRow['password'] . "</td>";
                                    echo "<td>" . $custRow['Phone'] . "</td>";
                                    echo "<td>" . $custRow['CarModel'] . "</td>"; 
                                    echo "<td>" . $custRow['Gender'] . "</td>";
                                    echo "<td>" . $custRow['Email'] . "</td>";
                                    echo "<td>" . $custRow['DOB'] . "</td>";
                                    echo "<td>" . $custRow['Address'] . "</td>";
                                    echo "<form method='POST'>";
                                    echo "<td class='text-center'><a href='#' id='".$custRow['ic']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>
                            </td>";
